...
class Encoder(nn.Module):
    def __init__(self, hidden_channels, filter_channels, n_heads, n_layers, kernel_size=1, p_dropout=0., window_size=4, **kwargs):
        ...
        for i in range(self.n_layers):
            ...
            self.norm_layers_1.append(modules.LayerNorm(hidden_channels))
            self.ffn_layers.append(FFN(
                hidden_channels, hidden_channels, filter_channels, kernel_size, p_dropout=p_dropout))
            self.norm_layers_2.append(modules.LayerNorm(hidden_channels))
...
class Decoder(nn.Module):
    def __init__(self, hidden_channels, filter_channels, n_heads, n_layers, kernel_size=1, p_dropout=0., proximal_bias=False, proximal_init=True, **kwargs):
        ...
        for i in range(self.n_layers):
            ...
            self.norm_layers_0.append(modules.LayerNorm(hidden_channels))
